        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <a class="btn btn-success" href="{{route('mesas.create')}}">
                        Crear Mesa
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form action="{{route('search.mesas')}}">
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>{{$mesa->nombre}}</td>
                        <td>{{$mesa->cubiertos}}</td>
                        <td>{{$mesa->area->nombre}}</td>
                        <td>
                            <form action="{{route('status.mesa',$mesa->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                @if($mesa->status==1)
