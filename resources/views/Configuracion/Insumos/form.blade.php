<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6"><input type="text" name="nombre" value="{{$insumo->nombre}}"
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6"><input type="text" name="descripcion" value="{{$insumo->descripcion}}"
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6"><input type="text" name="costo" value="{{$insumo->costo}}"
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6"><input type="text" name="precio_venta" value="{{$insumo->precio_venta}}"
